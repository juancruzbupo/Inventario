...
@section('content')
    ...
    <h1>Crear Transferencia <a href="{{ url('/transferencia') }}" class="btn btn-primary pull-right btn-sm">Ver Transferencia</a></h1>
    <hr/>

    {!! Form::open(['url' => 'transferencia', 'class' => 'form-horizontal' ,'id' => 'frm-example']) !!}
    ...
    @include('transferencia._mdestino')

@endsection

@section('script')

  {!! Html::script('public/assets/js/transferencia.js') !!}
  ...
  $(document).ready(function (){
     ...
     var table = $('#example').DataTable({
        ...
        'ajax': '{!! action("TransferenciaController@datatables") !!}',
        'columnDefs': [{
           'targets': 0,
           'searchable': false,
           'orderable': false,
