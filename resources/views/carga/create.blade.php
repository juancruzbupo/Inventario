...
@section('content')
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">{!! Form::select('tipo_comp',[''=>'Seleccionar...','factura'=>'Factura','remito'=>'Remito'], null, ['class' => '']) !!}</div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-6">{!! Form::select('proveedor',$proveedor, null, ['class' => '']) !!}</div>
  </div>
  <div class="form-group">
    ...
    <div class="form-group">
      {!! Form::label('deposito', 'Destino: ', ['class' => 'col-sm-3 control-label']) !!}
      <div class="col-sm-6">{!! Form::select('deposito',$deposito, null, ['class' => '']) !!}</div>
  </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="form-group">
              ...
              <div class="col-sm-6">{!! Form::select('cuenta',$cuenta, null, ['class' => 'select']) !!}  </div>
          </div>
          <div class="form-group">
              {!! Form::label('sub_cuenta','Sub Cuenta: ', ['class' => 'col-sm-3 control-label']) !!}
              <div class="col-sm-6">{!! Form::select('sub_cuenta',array('' => 'Seleccionar Cuenta...'), null, array('class'=>'selectize-input subcuenta','disabled'=> 'disabled')) !!}  </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
              ...
              <div class="col-sm-6">{!! Form::select('marca',$marca, null, ['class' => '']) !!}  </div>
          </div>
          <div class="form-group">
              {!! Form::label('modelo','Modelo: ', ['class' => 'col-sm-3 control-label']) !!}
              <div class="col-sm-6">{!! Form::select('modelo',$modelo, null, ['class' => '']) !!}  </div>
          </div>
          <div class="form-group">
